  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-blue-50 via-white to-indigo-50 dark:from-gray-900 dark:via-gray-800 dark:to-gray-900">
      <div className="max-w-6xl mx-auto px-4 py-8">
        ...
        <div className="text-center mb-12">
          <div className="inline-flex items-center gap-3 mb-6">
            <h1 className="text-4xl font-bold bg-gradient-to-r from-blue-600 to-indigo-600 bg-clip-text text-transparent dark:from-blue-400 dark:to-indigo-400">
              <a href="https://portal.wpeg.ca">WPEG: Prairie Home Calculator / Winnipeg Mortgage Calculator</a>
            </h1>
          </div>
          <p className="text-xl text-gray-600 dark:text-gray-100 max-w-2xl mx-auto mb-4">
            Smart mortgage calculator designed for Winnipeg, Manitoba real estate market conditions
          </p>
            ...
            <div className="space-y-6">
              ...
              <div>
                ...
                <div className="relative">
                  ...
                  <input
                    ...
                    className="w-full pl-10 pr-4 py-3 border border-gray-200 dark:border-gray-600 dark:bg-gray-700 dark:text-gray-100 rounded-xl focus:ring-2 focus:ring-blue-500 focus:border-transparent"
                    placeholder="400,000"
                  />
                </div>
              ...
              <div>
                ...
                <div className="relative">
                  ...
                  <select
                    ...
                    className="w-full pl-10 pr-4 py-3 border border-gray-200 dark:border-gray-600 dark:bg-gray-700 dark:text-gray-100 rounded-xl focus:ring-2 focus:ring-blue-500 focus:border-transparent appearance-none bg-white"
                  >
              ...
              <div>
                ...
                <select
                  ...
                  className="w-full px-4 py-3 border border-gray-200 dark:border-gray-600 dark:bg-gray-700 dark:text-gray-100 rounded-xl focus:ring-2 focus:ring-blue-500 focus:border-transparent appearance-none bg-white"
                >
              ...
              <>
                ...
                <div className="bg-white dark:bg-gray-800 rounded-3xl shadow-xl border border-gray-100 dark:border-gray-700 p-8">
                  ...
                  <div className="text-center mb-8">
                    <div className="text-5xl font-bold bg-gradient-to-r from-blue-600 to-indigo-600 dark:from-blue-400 dark:to-indigo-400 bg-clip-text text-transparent mb-2">
          ...
          <div className="max-w-4xl mx-auto">
            ...
            <div className="space-y-4 text-sm text-gray-600 dark:text-gray-300 leading-relaxed">
              ...
              <p className="text-center font-medium text-gray-700 dark:text-gray-300 pt-4 border-t border-gray-300 dark:border-gray-600">
                Last updated: August 24, 2025 | For educational purposes only | © 2025 Prairie Home Calculator | All rights reserved.
              </p>
        ...
        <div className="mt-16 bg-gray-50 dark:bg-gray-800 rounded-3xl p-8 border border-gray-200 dark:border-gray-700">
          <div className="max-w-4xl mx-auto"><div className="max-w-4xl mx-auto"><a href="https://portal.wpeg.ca"> &lt; &lt; Back to WPEG Portal</a></div></div>
        </div>
      </div>
